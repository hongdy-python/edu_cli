            ...
            <div class="course-content">
                <div class="course-tab-list">
                    <div class="tab-item" v-if="tabIndex==1">
                        ...
                        <div v-html="course_infor.brief_html"></div>
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        <div class="tab-item-title">
                            ...
                            <p class="chapter-length">共{{chapter_list.length}}章 {{course_infor.lessons}}个课时</p>
                        </div>
                        <!--           章节             -->
                        <div class="chapter-item" v-for="chapter in chapter_list">
                            ...
                            <ul class="lesson-list">
                                ...
                                <li class="lesson-item" v-for="(lesson,key) in chapter.coursesections">
                                    <p class="name">
                                        <span class="index">{{chapter.chapter}}-{{key+1}}</span>
                                        {{lesson.name}}
                ...
                <div class="course-side">
                    <div class="teacher-info">
                        ...
                        <div class="teacher-content">
                            <div class="cont1">
                                <img :src="course_infor.teacher.image">
                                <div class="name">
                                    <p class="teacher-name">{{course_infor.teacher.name}}</p>
                                    <!--                                    <p class="teacher-title">我永远18！</p>-->
                                    <p class="teacher-title">{{course_infor.teacher.title}}</p>
                                </div>
                            </div>
                            <p class="narrative">{{course_infor.teacher.signature}}</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            get_chapter() {
                this.$axios.get(`${this.$settings.HOST}course/list_chapter/`, {
                    params: {
